...
var format_KerentananFisik_2 = new ol.format.GeoJSON();
var features_KerentananFisik_2 = format_KerentananFisik_2.readFeatures(json_KerentananFisik_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_KerentananFisik_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_KerentananFisik_2.addFeatures(features_KerentananFisik_2);
var lyr_KerentananFisik_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_KerentananFisik_2, 
                style: style_KerentananFisik_2,
                popuplayertitle: 'Kerentanan Fisik',
                interactive: true,
    title: 'Kerentanan Fisik<br />\
    <img src="styles/legend/KerentananFisik_2_0.png" /> FASILITAS KRITIS<br />\
    <img src="styles/legend/KerentananFisik_2_1.png" /> FASILITAS UMUM<br />\
    <img src="styles/legend/KerentananFisik_2_2.png" /> RUMAH<br />' });
var format_KerentananLingkungan_3 = new ol.format.GeoJSON();
var features_KerentananLingkungan_3 = format_KerentananLingkungan_3.readFeatures(json_KerentananLingkungan_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_KerentananLingkungan_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_KerentananLingkungan_3.addFeatures(features_KerentananLingkungan_3);
var lyr_KerentananLingkungan_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_KerentananLingkungan_3, 
                style: style_KerentananLingkungan_3,
                popuplayertitle: 'Kerentanan Lingkungan',
                interactive: true,
    title: 'Kerentanan Lingkungan<br />\
    <img src="styles/legend/KerentananLingkungan_3_0.png" /> Hutan Alam<br />\
    <img src="styles/legend/KerentananLingkungan_3_1.png" /> Hutan Bakau/Mangrove<br />\
    <img src="styles/legend/KerentananLingkungan_3_2.png" /> Semak Belukar<br />' });
var format_KerentananSosial_4 = new ol.format.GeoJSON();
var features_KerentananSosial_4 = format_KerentananSosial_4.readFeatures(json_KerentananSosial_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_KerentananSosial_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_KerentananSosial_4.addFeatures(features_KerentananSosial_4);
var lyr_KerentananSosial_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_KerentananSosial_4, 
                style: style_KerentananSosial_4,
                popuplayertitle: 'Kerentanan Sosial',
                interactive: true,
    title: 'Kerentanan Sosial<br />\
    <img src="styles/legend/KerentananSosial_4_0.png" /> Rendah<br />\
    <img src="styles/legend/KerentananSosial_4_1.png" /> Sedang<br />\
    <img src="styles/legend/KerentananSosial_4_2.png" /> Tinggi<br />' });
...
lyr_ESRISatellite_0.setVisible(true);lyr_KerentananBencanaBanjir_1.setVisible(true);lyr_KerentananFisik_2.setVisible(true);lyr_KerentananLingkungan_3.setVisible(true);lyr_KerentananSosial_4.setVisible(true);lyr_BatasDusun_5.setVisible(true);
var layersList = [lyr_ESRISatellite_0,lyr_KerentananBencanaBanjir_1,lyr_KerentananFisik_2,lyr_KerentananLingkungan_3,lyr_KerentananSosial_4,lyr_BatasDusun_5];
...
lyr_KerentananFisik_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'NAMOBJ': 'NAMOBJ', });
lyr_KerentananLingkungan_3.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Lingkungan': 'Lingkungan', 'luas_ha': 'luas_ha', 'Shape_Area': 'Shape_Area', 'IKL': 'IKL', });
lyr_KerentananSosial_4.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'Luas_1': 'Luas_1', 'J_Penduduk': 'J_Penduduk', 'JP_LK': 'JP_LK', 'JP_PR': 'JP_PR', 'Disabilita': 'Disabilita', 'Rasio_Jeni': 'Rasio_Jeni', 'Rasio_Kepa': 'Rasio_Kepa', 'Rasio_PM': 'Rasio_PM', 'Rasio_Umur': 'Rasio_Umur', 'Rasio_Disa': 'Rasio_Disa', 'IKS': 'IKS', });
...
lyr_KerentananFisik_2.set('fieldImages', {'OBJECTID': 'TextEdit', 'NAMOBJ': 'TextEdit', });
lyr_KerentananLingkungan_3.set('fieldImages', {'OBJECTID': 'TextEdit', 'Lingkungan': 'TextEdit', 'luas_ha': 'TextEdit', 'Shape_Area': 'TextEdit', 'IKL': 'TextEdit', });
lyr_KerentananSosial_4.set('fieldImages', {'NAMOBJ': 'TextEdit', 'Luas_1': 'TextEdit', 'J_Penduduk': 'TextEdit', 'JP_LK': 'TextEdit', 'JP_PR': 'TextEdit', 'Disabilita': 'TextEdit', 'Rasio_Jeni': 'TextEdit', 'Rasio_Kepa': 'TextEdit', 'Rasio_PM': 'TextEdit', 'Rasio_Umur': 'TextEdit', 'Rasio_Disa': 'TextEdit', 'IKS': 'TextEdit', });
...
lyr_KerentananFisik_2.set('fieldLabels', {'OBJECTID': 'no label', 'NAMOBJ': 'inline label - visible with data', });
lyr_KerentananLingkungan_3.set('fieldLabels', {'OBJECTID': 'no label', 'Lingkungan': 'inline label - visible with data', 'luas_ha': 'inline label - visible with data', 'Shape_Area': 'hidden field', 'IKL': 'inline label - visible with data', });
lyr_KerentananSosial_4.set('fieldLabels', {'NAMOBJ': 'hidden field', 'Luas_1': 'no label', 'J_Penduduk': 'hidden field', 'JP_LK': 'hidden field', 'JP_PR': 'hidden field', 'Disabilita': 'hidden field', 'Rasio_Jeni': 'inline label - visible with data', 'Rasio_Kepa': 'inline label - visible with data', 'Rasio_PM': 'inline label - visible with data', 'Rasio_Umur': 'inline label - visible with data', 'Rasio_Disa': 'inline label - visible with data', 'IKS': 'inline label - visible with data', });
